...
def createCaptcha():
    ...
    img1 = Image.new(mode="RGB", size=(100, 30), color=(255, 255, 255))
    ...
    text = ""
    # 定义要使用的字体
    # font1 = ImageFont.truetype("./font-family/OneChance-Script.ttf", 28)
    font1 = ImageFont.truetype("./font-family/Monaco.ttf", 28)
    ...
    with open("./image/captcha-01.png", "wb") as f:
